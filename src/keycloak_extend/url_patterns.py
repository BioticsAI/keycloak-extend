...
URL_ADMIN_POLICY_PERMISSIONS = (
    URL_ADMIN_CLIENT + "/authz/resource-server/policy/{policy-id}/dependentPolicies"
)
URL_ADMIN_SCOPE_PERMISSION = (
    URL_ADMIN_CLIENT + "/authz/resource-server/permission/scope"
)
URL_ADMIN_RESOURCE_PERMISSION = (
    URL_ADMIN_CLIENT + "/authz/resource-server/permission/resource"
)
URL_ADMIN_PERMISSION = URL_ADMIN_CLIENT + "/authz/resource-server/permission"
URL_ADMIN_PERMISSION_ASSOCIATED_POLICIES = (
    URL_ADMIN_CLIENT
    + "/authz/resource-server/policy/{permission-id}/associatedPolicies"
)
